...
import { BananaChipsHeroImage } from "../images/hero-images"
import { getProductsByCategory } from "../../data/products"
import { getCategoryById } from "../../data/categories"

export default function BananaChipsPage({ onHomeClick, onAddToCart }) {
  const products = getProductsByCategory("banana-chips")
  const category = getCategoryById("banana-chips")
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex justify-center">
                <BananaChipsHeroImage alt="Banana and banana chips" />
              </div>
            </div>
          </div>
        </section>
